...
print(" ")
count_sex = penguins.groupby('sex')["sex"].count()
print(count_sex)
print(" ")
...
#Mediante esta única linea de código podemos sacar por pantalla los dos resultados anteriores.
#Como el resultado que sacamos con el método describe() es una tabla multiíndice,
#primero filtraremos por la columna "bill_length_mm" y dentro de esta columna, volvemos a
#filtrar por las columnas que nos interesa que son "count" y "mean"
...
gr_sex_sp = penguins.groupby(["sex","species"]).describe()
print(" ")
print("Agrupamos por 'sex' y 'species'")
print(" ")
print(gr_sex_sp) #Obtenemos información agrupando la columna de "sex" y "species"
print(" ")
...
penguins.drop(["body_mass_g"], axis=1, inplace=True) #Eliminamos la columna "body_mass_g"
print(" ")
print(penguins)
